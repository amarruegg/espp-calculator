    ...
    <div className="w-full px-4 py-8">
      ...
      <div className="max-w-[1400px] mx-auto">
        ...
        <div className="mb-8 max-w-[728px] mx-auto">
          <AdUnit slot="calculator-top" />
        </div>

      <div className="flex flex-col lg:flex-row gap-4 lg:gap-8 justify-between">
        {/* Left sidebar ad */}
        <div className="hidden lg:block w-[336px] space-y-4">
          <div className="sticky top-4">
            <AdUnit slot="calculator-sidebar-left-top" />
          </div>
          <div className="sticky top-[336px]">
            <AdUnit slot="calculator-sidebar-left-bottom" />
          </div>
        </div>

        {/* Main content container */}
        <div className="flex-1 w-full max-w-[1300px] mx-auto">
          {/* Form and Results flex container */}
          <div className="flex flex-col lg:flex-row gap-4 lg:gap-8 items-start justify-between">
            {/* Form section */}
            <div className="neu-element p-4 lg:p-6 shadow-lg w-full lg:w-[650px] flex-shrink-0">
              ...
              <form onSubmit={calculateResults} noValidate>
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                    ...
                    <div className="mb-4">
                      ...
                      <input
                        ...
                        className={`form-input appearance-none bg-white ${errors.offeringDate ? 'border-red-500' : ''}`}
                        style={{
                    ...
                    <div className="mb-4">
                      ...
                      <input
                        ...
                        onChange={handlePurchaseInfoChange}
                        className={`form-input appearance-none bg-white ${errors.purchaseDate ? 'border-red-500' : ''}`}
                        style={{
                          WebkitAppearance: 'none',
                          MozAppearance: 'none'
                        }}
                    ...
                    <div className="mb-4">
                      <label htmlFor="sharesSold" className="block mb-1 font-medium text-sm sm:text-base">
                        Shares Purchased <span className="text-xs text-gray-500">Box&nbsp;6</span>
                      </label>
                      <input
                        type="number"
                        id="sharesSold"
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                    ...
                    <div className="mb-4">
                      ...
                      <input
                        ...
                        onChange={handleSaleInfoChange}
                        className={`form-input appearance-none bg-white ${errors.saleDate ? 'border-red-500' : ''}`}
                        style={{
                          WebkitAppearance: 'none',
                          MozAppearance: 'none'
                        }}
                ...
                {/* Mid-form ad placement */}
                <div className="my-8">
                  <AdUnit slot="calculator-mid-form" format="in-article" />
                </div>
            ...
            {/* Results section */}
            <div ref={resultsRef} className="sticky top-4 w-full lg:w-[650px] flex-shrink-0 px-0">
              {/* Pre-results ad placement */}
              {!showResults && (
                <div className="mb-8">
                  <AdUnit slot="calculator-pre-results" />
                </div>
              )}
              {showResults && calculationResult ? (
                <div className="neu-element p-6 fade-in shadow-lg">
                  ...
                  {saleInfo.saleDate && saleInfo.salePrice > 0 ? (
                    <>
                      ...
                      <div className="mb-6">
                        <div className={`text-center p-3 rounded-lg mb-2 ${calculationResult.isQualifyingDisposition
                      ...
                      {/* Post-results ad placement */}
                      <div className="mt-8">
                        <AdUnit slot="calculator-post-results" format="in-article" />
                      </div>
                    </>
                  ) : (
                    <>
                ...
                <div className="neu-element p-6 min-h-[800px] flex flex-col items-center justify-center shadow-lg">
                  <div className="text-center text-gray-500 max-w-md">
                    ...
                    <h3 className="text-xl font-medium mb-4">ESPP Tax Calculator</h3>
                    <p className="text-lg mb-3">Enter your ESPP information and click "Calculate" to see results</p>
                    <p className="text-sm text-gray-400">Your tax calculation results will appear here, including adjusted cost basis, capital gains, and tax liability information.</p>
                  </div>
                </div>
              )}
            </div>
        ...
        <div className="hidden lg:block w-[336px] space-y-4">
          <div className="sticky top-4">
            <AdUnit slot="calculator-sidebar-right-top" />
          </div>
          <div className="sticky top-[336px]">
            <AdUnit slot="calculator-sidebar-right-bottom" />
          </div>
        </div>
      </div>
    </div>
